...
class _$_HomeState implements _HomeState {
  const _$_HomeState({required final List<Restaurant> restaurants})
  ...
  @override
  String toString() {
    return 'HomeState(restaurants: $restaurants)';
  }
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({required final List<Restaurant> restaurants}) =
      _$_HomeState;
